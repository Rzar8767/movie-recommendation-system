...
if __name__ == '__main__':
    ...
    # ------ Add/Update/Delete ------
    send_post('Add new movie document number 80000 that nobody likes', '/movie/document/80000', '[]')
    send_post('Add new movie document number 80001 that nobody likes', '/movie/document/80001', '[]')
    send_post('Add new movie document number 80002 that nobody likes', '/movie/document/80002', '[]')

    send_post('Add new user document number 90000, who likes movies 80000 and 80001', '/user/document/90000',
             '[80000, 80001]')
    ...
    send_put('Update user 90000, that he now likes movies 80000 and 80002', '/user/bulk',
